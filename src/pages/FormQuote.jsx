...
const FormQuote = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div
        className={`transition-all duration-300 ${sidebarOpen ? "w-64" : "w-16"} bg-indigo-700 text-white p-4 relative h-full`}
      >
        <button
          ...
          <ul>
            <li>
              ...
              >
                ...
                {sidebarOpen && <span className="text-xl font-medium">Dashboard</span>}
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                {sidebarOpen && <span className="text-xl font-medium">Form Quote</span>}
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                {sidebarOpen && <span className="text-xl font-medium">Blogs</span>}
              </Link>
            </li>
          </ul>
        </div>
